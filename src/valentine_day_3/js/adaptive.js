...
(function(win, lib) {
    ...
    function setBody() {
        ...
        if (lib.limitWidth) {
            doc.body.style.maxWidth = lib.limitWidth + 'px'
    ...
    function setRem() {
        ...
        var layoutHeight = docEl.getBoundingClientRect().height
            // console.log(layoutHeight)

        var rate = layoutView / layoutHeight
        if (rate > lib.maxRate) {
            layoutView = layoutHeight * lib.maxRate
            lib.limitWidth = layoutView
        }
