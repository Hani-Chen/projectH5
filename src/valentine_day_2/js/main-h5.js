;(function(cjs, an) {
  ...
  // symbols:
  ;(lib._01 = function() {
    this.spriteSheet = ss['main_h5_atlas_P_']
    this.gotoAndStop(0)
  ...
  ;(lib.chat_bg = function() {
    this.initialize(img.chat_bg)
  }).prototype = p = new cjs.Bitmap()
  p.nominalBounds = new cjs.Rectangle(0, 0, 750, 1624)
  ...
  ;(lib.jinruliaotian002xiaotu = function() {
    this.spriteSheet = ss['main_h5_atlas_P_']
    this.gotoAndStop(30)
  }).prototype = p = new cjs.Sprite()
  ;(lib.jinruliaotian003xiaotu = function() {
    this.spriteSheet = ss['main_h5_atlas_P_']
    this.gotoAndStop(31)
  }).prototype = p = new cjs.Sprite()
  ;(lib.jinruliaotian004xiaotu = function() {
    this.spriteSheet = ss['main_h5_atlas_P_']
    this.gotoAndStop(32)
  }).prototype = p = new cjs.Sprite()
  ;(lib.jinruliaotian01xiaotu = function() {
    this.spriteSheet = ss['main_h5_atlas_P_']
    this.gotoAndStop(33)
  }).prototype = p = new cjs.Sprite()
  ...
  ;(lib.jinrult04 = function(mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {})

    // 图层 1
    this.instance = new lib.jinruliaotian004xiaotu()
    this.instance.parent = this
    this.instance.setTransform(-140, -8.5)

    this.timeline.addTween(cjs.Tween.get(this.instance).wait(1))
  }).prototype = p = new cjs.MovieClip()
  p.nominalBounds = new cjs.Rectangle(-140, -8.5, 280, 17)
  ;(lib.jinrult03 = function(mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {})

    // 图层 1
    this.instance = new lib.jinruliaotian003xiaotu()
    this.instance.parent = this
    this.instance.setTransform(-149, -8.5)

    this.timeline.addTween(cjs.Tween.get(this.instance).wait(1))
  }).prototype = p = new cjs.MovieClip()
  p.nominalBounds = new cjs.Rectangle(-149, -8.5, 298, 17)
  ;(lib.jinrult02 = function(mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {})

    // 图层 1
    this.instance = new lib.jinruliaotian002xiaotu()
    this.instance.parent = this
    this.instance.setTransform(-140, -8.5)
  ...
  p.nominalBounds = new cjs.Rectangle(-140, -8.5, 280, 17)
  ;(lib.jinrult01 = function(mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {})

    // 图层 1
    this.instance = new lib.jinruliaotian01xiaotu()
    this.instance.parent = this
    this.instance.setTransform(-158, -8.5)

    this.timeline.addTween(cjs.Tween.get(this.instance).wait(1))
  }).prototype = p = new cjs.MovieClip()
  p.nominalBounds = new cjs.Rectangle(-158, -8.5, 316, 17)
  ;(lib.bujian1 = function(mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {})

    // 图层 1
    this.instance = new lib.yaochong()
    this.instance.parent = this
    this.instance.setTransform(-118.5, -81.5)

    this.instance_1 = new lib._05_1('synched', 0)
    this.instance_1.parent = this
    this.instance_1.setTransform(4.5, 32.5)
  ...
  p.nominalBounds = new cjs.Rectangle(-118.5, -81.5, 237, 163)
  ;(lib.bujian2 = function(mode, startPosition, loop) {
    this.initialize(mode, startPosition, loop, {})
  ...
  ;(lib.liaotianqipaoduihua = function(mode, startPosition, loop) {
    ...
    // 进入聊天1
    this.instance = new lib.jinrult01('synched', 0)
    this.instance.parent = this
    this.instance.setTransform(375, 166.5)
    ...
    // 进入聊天2
    this.instance_1 = new lib.jinrult02('synched', 0)
    this.instance_1.parent = this
    this.instance_1.setTransform(375, 193.5)
    ...
    // 进入聊天3
    this.instance_2 = new lib.jinrult03('synched', 0)
    this.instance_2.parent = this
    this.instance_2.setTransform(375, 220.5)
    ...
    // 进入聊天4
    this.instance_3 = new lib.jinrult04('synched', 0)
    this.instance_3.parent = this
    this.instance_3.setTransform(375, 247.5)
    ...
    // 图层 32
    this.instance_26 = new lib.bujian1('synched', 0)
    this.instance_26.parent = this
    this.instance_26.setTransform(133.5, 1151.5)
    this.instance_26.alpha = 0
    this.instance_26._off = true

    this.instance_27 = new lib.bujian2('synched', 0)
    this.instance_27.parent = this
    this.instance_27.setTransform(133.5, 1151.5)

    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.instance_26 }] }, 67)
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_26)
        .wait(67)
        .to({ _off: false }, 0)
        .to({ _off: true, alpha: 1 }, 2, cjs.Ease.get(-0.1))
        .wait(433)
    )
  ...
  // stage content:
  ;(lib.mainh5 = function(mode, startPosition, loop) {
    if (loop == null) {
      loop = false
    }
    this.initialize(mode, startPosition, loop, {})
    ...
    // 导航栏
    this.instance = new lib.liaotianwenwubaiguan('synched', 0)
    this.instance.parent = this
    this.instance.setTransform(375, 57.8)
    ...
    // 聊天对话
    this.instance_1 = new lib.liaotianqipaoduihua('synched', 0)
    this.instance_1.parent = this
    this.instance_1.setTransform(375, 2558.6, 1, 1, 0, 0, 0, 375, 2581.5)
    this.instance_1._off = true
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_1)
        ...
        .to({ _off: false }, 0)
        .wait(81)
        .to({ startPosition: 81 }, 0)
        .to({ y: 2356.1, startPosition: 84 }, 3)
        .wait(8)
        .to({ startPosition: 92 }, 0)
        .to({ y: 2146.1, startPosition: 96 }, 4)
        .wait(4)
        .to({ startPosition: 100 }, 0)
        .to({ y: 1981.1, startPosition: 103 }, 3)
        .wait(11)
        .to({ startPosition: 114 }, 0)
        .to({ y: 1791.1, startPosition: 117 }, 3)
        .wait(9)
        .to({ startPosition: 126 }, 0)
        .to({ y: 1611.1, startPosition: 130 }, 4)
        .wait(6)
        .to({ startPosition: 136 }, 0)
        .to({ y: 1428.6, startPosition: 140 }, 4)
        .wait(12)
        .to({ startPosition: 152 }, 0)
        .to({ y: 1196.1, startPosition: 155 }, 3)
        .wait(5)
        .to({ startPosition: 160 }, 0)
        .to({ y: 996.1, startPosition: 163 }, 3)
        .wait(10)
        .to({ startPosition: 173 }, 0)
        .to({ y: 806.1, startPosition: 177 }, 4)
        .wait(8)
        .to({ startPosition: 185 }, 0)
        .to({ y: 663.6, startPosition: 188 }, 3)
        .wait(5)
        .to({ startPosition: 193 }, 0)
        .to({ y: 473.6, startPosition: 196 }, 3)
        .wait(12)
        .to({ startPosition: 208 }, 0)
        .to({ y: 258.6, startPosition: 213 }, 5)
        .wait(6)
        .to({ startPosition: 219 }, 0)
        .to({ y: 111.1, startPosition: 222 }, 3)
        .wait(13)
        .to({ startPosition: 235 }, 0)
        .to({ y: -86.4, startPosition: 239 }, 4)
        .wait(12)
        .to({ startPosition: 251 }, 0)
        .to({ y: -263.9, startPosition: 254 }, 3)
        .wait(5)
        .to({ startPosition: 259 }, 0)
        .to({ y: -466.4, startPosition: 261 }, 2)
        .wait(11)
        .to({ startPosition: 272 }, 0)
        .to({ y: -603.9, startPosition: 275 }, 3)
        .wait(7)
        .to({ startPosition: 282 }, 0)
        .to({ y: -796.4, startPosition: 284 }, 2)
        .wait(16)
        .to({ startPosition: 300 }, 0)
        .to({ y: -1141.4, startPosition: 303 }, 3)
        .wait(28)
        .to({ startPosition: 331 }, 0)
        .to({ y: -1333.9, startPosition: 333 }, 2)
        .wait(12)
        .to({ startPosition: 345 }, 0)
        .to({ y: -1548.9, startPosition: 349 }, 4)
        .wait(3)
        .to({ startPosition: 352 }, 0)
        .to({ y: -1743.9, startPosition: 355 }, 3)
        .wait(3)
    )

    // 背景图
    this.instance_2 = new lib.chat_bg()
    this.instance_2.parent = this
  ...
  // library properties:
  lib.properties = {
    id: 'F074CD74B06B45D0B087B7D9982ADCAD',
    width: 750,
    height: 1624,
    fps: 12,
    color: '#666666',
    opacity: 1.0,
    manifest: [
      { src: staticPrefix + 'img/chat_bg.jpg', id: 'chat_bg' },
      {
        src: staticPrefix + 'img/main_h5_atlas_P_.png',
        id: 'main_h5_atlas_P_'
      },
      {
        src: staticPrefix + 'audio/jinruliaotianwav.mp3',
        id: 'jinruliaotianwav'
      },
      { src: staticPrefix + 'audio/newmsg.wav', id: 'fasongxiaoxiwav' }
  ...
  an.compositions['F074CD74B06B45D0B087B7D9982ADCAD'] = {
    getStage: function() {
